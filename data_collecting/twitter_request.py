...
# query = 'climatechange OR ecofriendly OR sustainable OR zerowaste OR environment OR climateaction OR savetheplanet -is:retweet'

# response = client.search_recent_tweets(query=query, max_results=20, tweet_fields=['lang', 'context_annotations', 'geo'], expansions=['author_id' ])

# columns = ['tweetId', 'tweet', 'lang', '']
# data = []
...
# TODO: create a schedular that run the request every 15 mins 
# TODO: Start cleaning data
